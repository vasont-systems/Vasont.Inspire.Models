//--------------------------------------------------------------------
// <copyright file="ReviewComponentModel.cs" company="Vasont Systems">
...
namespace Vasont.Inspire.Models.Reviews
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReviewComponentModel"/> class.
        /// </summary>
        public ReviewComponentModel()
        {
