//-------------------------------------------------------------
// <copyright file="ComponentTranslationsResultModel.cs" company="GlobalLink Vasont">
...
namespace Vasont.Inspire.Models.Components
{
    ...
    public class ComponentTranslationsResultModel
    {
        ...
        /// </summary>
        public List<TranslationJobRelationModel> ComponentTranslations { get; set; } = new List<TranslationJobRelationModel>();
    }
}